...
import 'package:cab200final/widgets/place_prediction_tile.dart';
...
class _SearchPlacesScreenState extends State<SearchPlacesScreen> {
  ...
  findPlaceAutoCompleteSearch(String inputText) async{
    if(inputText.length>1){
      ...
      if(responseAutoCompleteSearch == "Error Occured. Failed. No Reponse."){
        return;
      }
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            "Search & Set your DropOff Location",
